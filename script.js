...
const fallbackData = {
  ...
  infoCards: [
    ...
    { number: "04", title: "Форма проведення іспиту", answer: "Офлайн / онлайн" }
  ],
  steps: ["Подача документів", "Консультація", "Іспит", "Отримання сертифікату"],
  results: [
    ...
    "Внесення в національний реєстр власників сертифіката",
  ...
  reviews: [
    ...
    { name: "Анна Т.", text: "Зручно, сучасно та швидко — саме те, що потрібно для отримання сертифікату." }
  ]
};
